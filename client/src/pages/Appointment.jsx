    ...
    docInfo && (
      <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <p className="flex items-center gap-2 text-2xl font-medium text-gray-900">
              ...
              <img
                className="w-5"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4gKSA4wTYk8c2mE0CMgn5yvIk3dCOClZYSg&s"
                alt=""
              />
            </p>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700">
          ...
          <div className="flex items-center gap-1 w-full overflow-x-scroll mt-4">
            {docSlots.length &&
              docSlots[slotIndex].map((item, index) => {
                return (
                  <p
                    ...
                    className={`text-sm font-light flex-shrink-0 px-2 py-2 rounded-full cursor-pointer ${
                      item.time === slotTime
                        ? "bg-primary text-white"
